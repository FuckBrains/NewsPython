...
class Twitterbot:
	...
	def login(self):
		...
		email = bot.find_element_by_xpath(
			'//*[@id ="react-root"]/div/div/div[2]/main/div/div/div/form/div/div/label/div/div/div/input[@name="session[username_or_email]"]'
		)
		password = bot.find_element_by_xpath(
			'//*[@id ="react-root"]/div/div/div[2]/main/div/div/div/form/div/div/label/div/div/div/input[@name="session[password]"]'
		)
