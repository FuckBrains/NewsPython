...
chromedriver = 'C:\\Users\\Admin\\PycharmProjects\\news\\chromedriver.exe'
...
def download_google_staticimages():
    ...
    try:
        browser.find_element_by_xpath("//div[text()='Tools']").click()
        browser.find_element_by_xpath("// div[text() = 'Usage Rights']").click()
        browser.find_element_by_xpath("//span[text()='Creative Commons licenses']").click()
        browser.find_element_by_xpath("// div[text() = 'Size']").click()
        time.sleep(0.3)
        browser.find_element_by_xpath("//span[text() = 'Large']").click()
    except:
        time.sleep(0.3)
    ...
    try:
        ...
        try:
            browser.find_element_by_xpath("//span[text()='See more anyway']").click()
        except:
            if(browser.find_element_by_xpath("//div[contains(text(),\"Looks like you\'ve reached the end\")]").is_displayed()):
                browser.quit()
